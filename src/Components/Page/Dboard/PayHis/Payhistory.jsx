...
const Payhistory = () => {
  ...
  //      queryFn:async()=>{
  //           const res = await fetch('https://jewelry-server-q5rp0hk9y-ahad188.vercel.app/history')
  //           return res.json()
  //      }
  // })
  ...
  const handelDelate = (item) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        fetch(`https://jewelry-server-q5rp0hk9y-ahad188.vercel.app/history/${item._id}`, {
          method: "DELETE",
        })
          .then((res) => res.json())
          .then((data) => {
